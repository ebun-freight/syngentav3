...
const pickupFieldSchema = new mongoose.Schema(
  {
    ...
    fieldId: {
      ...
      trim: true,
      uppercase: true,
      maxlength: [50, 'Field ID cannot exceed 50 characters']
    },
    growerName: {
      type: String,
      trim: true,
      maxlength: [100, 'Grower Name cannot exceed 100 characters'],
      match: [/^[a-zA-Z\s'.,-]+$/, 'Grower Name must contain letters only']
    },
    areaHectares: {
      type: Number,
